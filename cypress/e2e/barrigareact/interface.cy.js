...
describe('Casos de testes funcionais em barrigareact', () => {
    ...
    context('Outros testes', () => {
        ...
        it('Insersão de movimento', () => {
            ...
            cy.intercept({
                method: 'GET',
                url: `${backEndBaseUrl}/extrato/**`
            }, {
                body: [
                    {
                        conta: "Conta com movimentacao",
                        id: 1,
                        descricao: transaction,
                        envolvido: "Interessado de exemplo",
                        observacao: null,
                        tipo: "REC",
                ...
                body: [
                    {
                        conta: "Conta com movimentacao",
                        id: 1,
                        descricao: transactionToExclude,
                        envolvido: "Interessado de exemplo",
                        observacao: null,
                        tipo: "REC",
                        data_transacao: dayjs(new Date).format('DD/MM/YYYY'),
